            ...
            <div className="CompletedRecruit_mainContent">
              <div className="CompletedRecruit_volSelect">
                ...
                <table className="CompletedRecruit_tableList">
                  <thead className="CompletedRecruit_thead">
                    <tr className="CompletedRecruit_tr" style={{ display: 'inline-block' }} >
                      <th className="CompletedRecruit_tableListIdx">번호</th>
                      <th className="CompletedRecruit_tableListIdx">제목</th>
                      <th className="CompletedRecruit_tableListIdx">유형</th>
                      <th className="CompletedRecruit_tableListIdx">모집기간</th>
                        ...
                        <span key={idx}>
                          {rowData.volCurNumber !== rowData.volRecPersonnel && new Date() > new Date(rowData.volRecPeriod) ?
                            <tr key={idx}>
                              ...
                              <td>{dayjs(rowData.volRecPeriod).format('YYYY-MM-DD hh:mm')}</td>
