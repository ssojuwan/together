        ...
        if (testData.volTitle === "") {
            ...
            axios.get("/together/create/volunteer", {
                ...
                .then((response) => {
                    ...
                    // dispatch(changeVolunteerSelect({
                    //     volId: resData.volId,
                    //     volRecPersonnel: resData.volRecPersonnel,
                    //     volCurNumber: resData.volCurNumber,
                    //     volRecPeriod: resData.volRecPeriod,
                    //     volType: resData.volType,
                    //     volOrganization: resData.volOrganization,
                    //     volLocation: resData.volLocation,
                    //     volStTime: resData.volStTime,
                    //     volEndTime: resData.volEndTime,
                    //     volTitle: resData.volTitle,
                    //     volContent: resData.volContent
                    // }));  // dispatch로 상태 변환해준다.
    ...
    return (
        <div>
            ...
            <div><button style={{ margin: "10px", fontSize: "20px" }}></button>
                <button style={{ margin: "10px", fontSize: "20px" }} onClick={testClick1}>등록하기</button>
