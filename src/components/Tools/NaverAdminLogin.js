...
const NaverAdminLogin = (props, { setGetToken, setUserInfo }) => {
    ...
    useEffect(() => {
        ...
        naverScript.onload = () => {
            const naverLogin = new window.naver.LoginWithNaverId({
                ...
                callbackUrl: "http://localhost:3000/AdminLoadingPage",
                callbackHandle: true,
                isPopup: false,
                loginButton: {
                    color: "green",
            ...
            localStorage.setItem('loginType', 'man');
        }
    }, [])
    const handleClick = () => {
...
export default NaverAdminLogin;