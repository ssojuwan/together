...
function Header(props) {
  ...
  const adminName = useSelector((state) => state.user.manager_Information.orgManName); // 서비스 관리자
  ...
  */
  ...
  if(loginInfo === "unLogined") { // 로그인이 안되어있을때
    loginComponent = (
      <>
        <Link to='/SignIn'><Button btnStyle={{float:"right", margin:"5px"}} spanStyle={{margin:"5px"}} btnName='로그인'/></Link>
      </>
    )
    ...
    loginComponent = (
      <>
        ...
        <Link to='/MyPage'><Button btnStyle={{float:"right", margin:"5px"}} spanStyle={{margin:"5px"}} btnName='내정보'/></Link>
    ...
    loginComponent = (
      <>
        <Button btnStyle={{float:"right", margin:"5px"}} spanStyle={{margin:"5px"}} btnName='로그아웃' customClickEvent={logout}/>
        <Link to='/AdminPage'><Button btnStyle={{float:"right", margin:"5px"}} spanStyle={{margin:"5px"}} btnName='봉사관리'/></Link>
        <div className='header-box2-name'><strong>{orgName}</strong>님 환영합니다!&nbsp;&nbsp;</div>
      </>
    )
    ...
    loginComponent = (
      <>
        <Button btnStyle={{float:"right", margin:"5px"}} spanStyle={{margin:"5px"}} btnName='로그아웃' customClickEvent={logout}/>
        <div className='header-box2-name'><strong>{adminName}</strong>님 환영합니다!&nbsp;&nbsp;</div>
      </>
    )
