...
const NoticeView = () => {// eslint-disable-line no-unused-vars
  ...
  return (
    ...
    <Header />
      <NavBar />
      <NoticeForm />
      <h2 className='h2_PV'>게시글 상세정보</h2>

      <div className="postWrapper_PV">
        {
          data ? (
            <>

              <div className="postRow_PV">
                <label>제목</label>
        ...
        <div>
         {loginType === "admin" ? <button className="btn_PV" onClick={onRemove}>게시글 삭제</button> :<></>}
        <button className="btn_PV" onClick={handleGoBack}>목록으로 돌아가기</button>
        </div>
